...
class SearchSkipped(AdapterError):
    """Поиск по одной коллекции невозможен, остальные не задеты.

    Отдельный тип нужен, чтобы опечатка в названии коллекции не
    выглядела как отказ всей площадки и не останавливала проход.
    """
